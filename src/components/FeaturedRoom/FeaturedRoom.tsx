...
const FeaturedRoom:FC<Props> = (props) => {
  ...
  return (
    <section className="flex md:flex-row flex-col px-4 sm:px-8 py-10 items-center gap-12 container mx-auto">
      ...
      <div className="md:py-10 md:w-1/2 text-left">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
              <div className="flex mb-3 md:mb-0">
                <div className="flex gap-3 flex-col items-center justify-center mr-4">
                  ...
                  <p className="md:font-bold flex font-medium text-2xl xl:text-4xl">
                    {featuredRoom.price} €
                  </p>
                </div>
                <div className="flex gap-3 flex-col items-center justify-center mr-4">
            ...
            <Link href={`/rooms/${featuredRoom.slug.current}`} className="border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-5 lg:px-7 rounded-2xl font-bold lg:text-xl hover:bg-tertiary-dark hover:text-white hover:border-none">
            More Details
            </Link>
            </div>
      </div>
